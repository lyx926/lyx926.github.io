...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在您的网络浏览器中导航到“http://localhost:9000”以访问portainer web界面并创建一个帐户。</p>`,2)),s("h4",C,[n[29]||(n[29]=s("a",{class:"header-anchor",href:"#用以下工具将容器停住","aria-hidden":"true"},"#",-1)),n[30]||(n[30]=e()),s("a",S,[i(a)]),n[31]||(n[31]=e("用以下工具将容器停住"))]),n[56]||(n[56]=l(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">docker</span> compose down
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1)),s("h3",N,[n[32]||(n[32]=s("a",{class:"header-anchor",href:"#参考资料","aria-hidden":"true"},"#",-1)),n[33]||(n[33]=e()),s("a",M,[i(a)]),n[34]||(n[34]=e("参考资料"))]),s("ul",null,[s("li",null,[s("a",I,[n[35]||(n[35]=e("官方文档")),i(a)])])]),s("h3",L,[n[36]||(n[36]=s("a",{class:"header-anchor",href:"#docker-compose-yml的详细解释与说明","aria-hidden":"true"},"#",-1)),n[37]||(n[37]=e()),s("a",P,[i(a)]),n[38]||(n[38]=e("docker-compose.yml的详细解释与说明"))]),s("h4",F,[n[39]||(n[39]=s("a",{class:"header-anchor",href:"#_1主要配制","aria-hidden":"true"},"#",-1)),n[40]||(n[40]=e()),s("a",H,[i(a)]),n[41]||(n[41]=e("1主要配制"))]),n[57]||(n[57]=l(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>version <span class="token comment">#定义了版本信息，这个定义关乎与docker的兼容性，Compose 文件格式有3个版本,分别为1, 2.x 和 3.x,目前主流的为 3.x 其支持 docker 1.13.0 及其以上的版本</span>
