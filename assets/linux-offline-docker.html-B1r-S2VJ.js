import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as d,c as o,b as s,d as a,e as t,a as c}from"./app-DSHSP0cU.js";const r={},p={href:"https://download.docker.com/linux/ubuntu/dists/jammy/pool/stable/amd64/",target:"_blank",rel:"noopener noreferrer"};function u(m,n){const e=l("ExternalLinkIcon");return d(),o("div",null,[n[1]||(n[1]=s("h3",{id:"下载离线包",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#下载离线包","aria-hidden":"true"},"#"),a(" 下载离线包")],-1)),s("p",null,[s("a",p,[n[0]||(n[0]=a("https://download.docker.com/linux/ubuntu/dists/jammy/pool/stable/amd64/",-1)),t(e)])]),n[2]||(n[2]=c(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>containerd.io_1.6.9-1_amd64.deb
