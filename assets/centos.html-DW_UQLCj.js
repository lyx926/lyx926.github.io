import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,o as e,a as i}from"./app-BIKEHu4G.js";const l={};function c(t,n){return e(),a("div",null,n[0]||(n[0]=[i(`<h3 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>待补充
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,58)]))}const d=s(l,[["render",c],["__file","centos.html.vue"]]);export{d as default};
